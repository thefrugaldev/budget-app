...
import { FinnhubSearchProvider } from "./finnhub-search";
...
/** A combobox stays scannable at a handful of options; Finnhub returns far more. */
...
const defaultProvider = new FinnhubSearchProvider();
