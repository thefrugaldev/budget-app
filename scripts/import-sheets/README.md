...
## What's here (chunk 1 — pure transforms)
...
- **Chunk 2 — `extract` CLI:** read workbooks, build manifests + reconciliation
  and vendor reports, validate icons against the app catalog, warn on lock
  files. Deterministic; no DB writes.
